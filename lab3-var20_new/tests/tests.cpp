...
TEST(VectorTest, TotalArea) {
    ...
    Point pp1(1, 0), pp2(0.309, 0.951), pp3(-0.809, 0.588),
          pp4(-0.809, -0.588), pp5(0.309, -0.951);
...
TEST(VectorTest, SeparateGeomCenterAndArea) {
    ...
    Pentagon* p = new Pentagon(
        Point(0, 0), Point(1, 0), Point(1, 1), Point(0.5, 1.5), Point(0, 1)
    );
    v.PushBack(p);
...
TEST(PolymorphismTest, VirtualMethods) {
    ...
    Pentagon* p = new Pentagon(
        Point(0, 0), Point(2, 0), Point(2, 2), Point(1, 3), Point(0, 2)
    );
